...
});sound('success');toast(`Withdrawal submitted. ${fmt(d.pointsLocked)} ZN locked for review.`);document.querySelector('#amount').value='';document.querySelector('#account').value=''}catch(e){sound('error');toast(e.message)}}
