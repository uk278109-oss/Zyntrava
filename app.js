...
async function ensureProfile(u){try{Z.user=u;await api('bootstrap-user',{});const code=new URLSearchParams(location.search).get('ref');if(code)await api('register-referral',{code});}catch(e){console.error('Profile bootstrap failed:',e)}}
